...
def main(args):
    ...
    inflow_predicts, inflow_labels, outflow_predicts, outflow_labels = net.eval_epoch(epoch = 0, val_dataloader = dataloader, log_path = None)
    plot(inflow_predicts, inflow_labels, outflow_predicts, outflow_labels, args.save_dir)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_dir", type=str, default="result/16/")
